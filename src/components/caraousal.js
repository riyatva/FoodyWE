...
export default function caraousal() {
  return (
    <div><div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel" style={{objectFit:"cointain ! important"}}> </div>
    ...
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/300x300?seas" className=" d-block w-100" style={{ filter:"brightness(30%)" }} alt="..."/>
    </div>
  </div>
